      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-4">
          <div className="space-y-2">
            <label className="text-sm font-semibold text-gray-700">Story Media URL</label>
            <div className="flex gap-2">
              <div className="flex-1 relative">
                <input
                  type="text"
                  placeholder="Paste an image or video URL here..."
                  className="w-full bg-gray-100 border-none rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                  value={imageUrl}
                  onChange={(e) => {
              ...
              <button
                ...
                className="bg-blue-50 text-blue-600 px-4 py-2 rounded-xl hover:bg-blue-100 transition-colors flex items-center gap-2 text-sm font-semibold whitespace-nowrap"
              >
                <Upload size={18} />
                Upload
              </button>
            ...
            <input 
              ...
              className="hidden" 
            />
            <p className="text-xs text-gray-400">Your story will be visible to your friends for 24 hours.</p>
          </div>

          {imageUrl && (
            <div className="relative aspect-[9/16] max-h-[400px] rounded-xl overflow-hidden bg-gray-100 border border-gray-200 mx-auto">
              {contentType === 'image' ? (
                <img 
                  src={imageUrl} 
                  alt="Story Preview" 
